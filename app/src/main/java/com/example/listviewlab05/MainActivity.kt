...
class MainActivity : AppCompatActivity() {
    var arrSO = arrayOf("Android","iOS","Firefox OS","BlackBerry","Windows phone","Amazon World")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lsvSO.setOnItemClickListener { parent, view, position, l ->
            Toast.makeText(this,"Estamos en la posicion: $position",Toast.LENGTH_LONG).show()
        }
    }
}